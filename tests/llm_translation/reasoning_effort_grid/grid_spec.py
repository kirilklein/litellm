...
AZURE_AI_MODELS: Tuple[ModelEntry, ...] = (
    ModelEntry(
        ...
        fail_reason=(
            ...
            "creates the opus-4-8 deployment); this cell stays loud in CI — "
...
VERTEX_AI_MODELS: Tuple[ModelEntry, ...] = (
    ModelEntry(
        ...
        fail_reason=(
            ...
            "confirmed for this brand-new release; this cell stays loud in CI "
            "until verified — remove this fail_reason once the model is "
